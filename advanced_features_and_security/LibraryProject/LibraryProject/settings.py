...
SECRET_KEY = 'django-insecure-q4sp3kjzj%y$y61(r-5qpj80^6^un4f(f)%gsz&_mm8^u17g%$'
...
# =====================================================
# SECURE HEADERS (Clickjacking, XSS, MIME sniffing)
# =====================================================

# Prevent site from being displayed in a frame (clickjacking protection)
X_FRAME_OPTIONS = "DENY"
...
# so it can correctly detect HTTPS behind a load balancer or reverse proxy
